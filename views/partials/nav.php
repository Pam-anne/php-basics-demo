      ...
      <div class="flex items-center">
        ...
        <div class="hidden md:block">
          <div class="ml-10 flex items-baseline space-x-4">
            ...
            <a href="/" class="<?= urlIs("/") ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium text-white" aria-current="page">Home</a>
            ...
            <?php if ($_SESSION['user'] ?? false) : ?>
              <a href="/employee" class="<?= urlIs("/employee") ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium text-white" aria-current="page">Employee</a>
            <?php endif;?>
        ...
        <div class="ml-4 flex items-center md:ml-6">
          ...
          <div class="relative ml-3">
            <div>
              ...
              <?php else: ?>
                <a href="/register" class="<?= urlIs("/register") ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium text-white" aria-current="page">Register</a>
                <a href="/login" class="<?= urlIs("/login") ? "bg-gray-900 text-white" : "text-gray-300"; ?> rounded-md text-gray-300 hover:bg-gray-700 px-3 py-2 text-sm font-medium text-white" aria-current="page">Login</a>
